...
export const DOLLS: DollDef[] = [
  {
    ...
    category: 'daily',
    spawnWeight: 3,
    bodyHalfExtents: { x: 0.12, y: 0.14, z: 0.12 },
    mass: 0.5,
  },
  {
    id: 'lamb',
    ...
    category: 'fashion',
    spawnWeight: 2,
    bodyHalfExtents: { x: 0.12, y: 0.13, z: 0.12 },
    mass: 0.45,
  },
  // ↓ GLB 추가 전까지는 프리미티브로 표시 (modelUrl을 추가하면 자동으로 GLB 사용)
  {
    ...
    category: 'daily',
    spawnWeight: 4,
    bodyHalfExtents: { x: 0.10, y: 0.10, z: 0.10 },
    mass: 0.4,
  },
  {
    id: 'star_pink',
    ...
    category: 'season',
    spawnWeight: 2,
    bodyHalfExtents: { x: 0.11, y: 0.11, z: 0.11 },
    mass: 0.45,
  },
  {
    id: 'gem_legend',
    ...
    category: 'fantasy',
    spawnWeight: 1,
    bodyHalfExtents: { x: 0.11, y: 0.14, z: 0.11 },
    mass: 0.55,
  },
];
